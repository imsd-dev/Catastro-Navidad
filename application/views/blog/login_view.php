...
<div class="container" style="width: 100%">
     <div class="row">
             ...
             <div style="float: left;  width :70%" class="form-group">
...
<div class="container" style="width: 80%;float: right;">
     <div class="row" style="width: 70%">
          ...
          echo form_open(base_url('index.php/blog/index'), $attributes);?>
          <fieldset>
               ...
               <div class="col-lg-12 col-sm-12 text-center">
                    <input id="btn_login" name="btn_login" type="submit" class="btn btn-default" value="Iniciar Sesion" />
               </div>
               </div>
          </fieldset>
          <?php echo form_close(); ?>
